...
{
    /// <summary>Default Mirror NetworkManagerHUD with added field for entering nickname.</summary>
    [DisallowMultipleComponent]
    [AddComponentMenu("Network/Custom Network HUD")]
    ...
    public class CustomNetworkManagerHUD : MonoBehaviour
    {
        ...
        private void StartButtons()
        {
            if (!NetworkClient.active)
            {
                ...
                manager.Nickname = GUILayout.TextField(manager.Nickname);
